...
aznaur= Song.create!(name:"La bohème", artist:aznaur )
aznaur= Song.create!(name:"la vie d'Amoure", artist:aznaur )
aznaur= Song.create!(name:"La Mamma", artist:aznaur )
aznaur= Song.create!(name:"Je me voyais déjà", artist:aznaur )
...
photo3 = Photo.create!(remote_image_url: "http://res.cloudinary.com/dh4hgusrb/image/upload/v1510493562/Beyonce_Knowles_with_necklaces_fxwlae.jpg", arist:beyonce )
